...
public class PlotUlam2 extends JPanel {
  ...
  public PlotUlam2(JFrame p_frm) {
    ...
    p_frm.setTitle("Plot2 della spirale di Ulam");
  }
  ...
  private void initData() {
    ...
    for (long ii : liPrim) {
      CerchioSpir2 cc = CerchioSpir2.getSpirale((int) ii);
  ...
  public static void main(String[] args) {
    SwingUtilities.invokeLater(new Runnable() {
      ...
      public void run() {
        ...
        PlotUlam2 pan = new PlotUlam2(frm);
        frm.add(pan);
